...
int main()
{
	...
	strcat(ionstart, BA_ION_CONFIG_FILE);
	strcat(ionstart, " > /dev/null");
	printf("Starting ION node 180...\n");	
	system(ionstart); 
	...
	printf("---> Bundle Agent node active.\n-------------------Press CTRL+C to stop the node-------------------\n");
	...
	printf("Bundle Node terminated.\n---> BP Agent node was stopped successfully\n");
}
